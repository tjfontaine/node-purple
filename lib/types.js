...
var PluginList = exports.PluginList = Struct({ data: PurplePluginPtr });
var PluginListPtr = exports.PluginListPtr = ref.refType(PluginList);
PluginList.defineProperty('next', PluginListPtr);
PluginList.defineProperty('prev', PluginListPtr);
